...
interface LoadingOverlayProps {
  ...
  /** Current initialization step (1, 2, or 3) */
  initStep: 1 | 2 | 3;
}
...
export const LoadingOverlay = memo(function LoadingOverlay({
  ...
  return (
    ...
    >
      <div className="relative z-10 w-full max-w-lg px-8 py-6 bg-white/10 border border-white/20 rounded-3xl backdrop-blur-2xl shadow-2xl">
        ...
        <div className="flex items-center justify-between mb-4 gap-4">
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <div className="text-xs font-medium text-gray-700 uppercase tracking-wide whitespace-nowrap">
