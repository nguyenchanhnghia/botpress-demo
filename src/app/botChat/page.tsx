    ...
    const type = () => {
      ...
      if (!isDeleting) {
        ...
        if (charIndex === fullText.length) {
          // When the whole text is typed, pause for 2.5 seconds before deleting
          isDeleting = true;
        ...
        if (charIndex === 0) {
          // When deletion is done, switch to the next phrase after a short pause
          isDeleting = false;
          setPlaceholderIndex((prev) => (prev + 1) % placeholderPhrases.length);
          timeout = setTimeout(type, 800); // small delay before typing next phrase
          return;
        }
      }

      // Typing speed: slower when typing forward, faster when deleting
      ...
      <ProtectedRoute>
        <div className="h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
          <div className="text-center">
            <div className="w-16 h-16 bg-gradient-to-r from-red-500 to-yellow-600 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="sticky top-0 z-50 bg-white/70 backdrop-blur-xl border-b border-white/20 p-4">
          <div className="max-w-4xl mx-auto flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold bg-gradient-to-r from-red-600 to-yellow-600 bg-clip-text text-transparent">TVJ Internal Assistant</h1>
              </div>
            </div>
