                            ...
                            <tbody>
                                {files.map((file, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <td className="py-3 px-4 font-mono text-sm text-gray-800 break-words whitespace-normal">{index + 1}</td>
                                            <td className="py-3 px-4 font-mono text-sm text-gray-800 break-words whitespace-normal">{file.key}</td>
                                            <td className="py-3 px-4 min-w-[12rem] break-words whitespace-normal">
                                                <MultiSelect
                                                    options={ROLES}
                                                    value={selectedRoles}
                                                    onChange={(v) => { setSelectedRolesMap((prev) => ({ ...prev, [file.id]: v })) }}
